...
For example, the class Cat would contain all the individuals that are cats in our domain of interest. [2]
...
[2] Individuals can belong to more than one class and classes can have more than one superclass.
