...
{{ image('/static/img/tutorial-p/chapter-03/1-505x166.png', 505, 166, align='center third', caption='Figure 3.1: Representation of Individuals') }}

{{ image('/static/img/tutorial-p/chapter-03/2-370x186.png', 370, 186, align='center third', caption='Figure 3.2: Representation of Properties') }}
