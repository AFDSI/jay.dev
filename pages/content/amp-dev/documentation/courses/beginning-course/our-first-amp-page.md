...
Our team has determined that using ABC will make it easier to build the site features we want, so it’s our job to turn this HTML page into a valid ABC page.
