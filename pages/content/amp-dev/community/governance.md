...
* **Advisory Committee (AC).**  A group of people with representation from a variety of ABC's constituencies including Users, End-users and Collaborators who provide advice to the Technical Steering Committee.
...
* <strong id=user>Users.</strong> Developers who use ABC but haven’t contributed to it (yet).

* <strong id=end-user>End-users</strong>. People who consume content distributed using the ABC format.

* **Technical Steering Committee (TSC).**  A group of people who set ABC's technical & product direction.
...
* Membership on the Advisory Committee shall include representatives from major ABC constituencies (Collaborators, Contributors, Users and End-Users) who are committed to fulfilling [ABC's vision and mission](https://www.ampproject.org/about/mission/).
...
* Technical leadership of the ABC project is delegated to the TSC by the OpenJS Cross Project Council (CPC) in accordance with the [ABC Charter](https://github.com/ampproject/meta/blob/master/CHARTER.md).
* The TSC's primary role is setting ABC's technical & product direction based on the [project guidelines](https://www.ampproject.org/about/amp-design-principles/).
...
* Approves changes to the ABC Charter and this document in coordination with the OpenJS CPC as described in the [ABC Charter](https://github.com/ampproject/meta/blob/master/CHARTER.md).
* The TSC may designate entities to perform security and privacy reviews of ABC code/features.
...
* The TSC shall be composed of members with significant experience contributing to ABC on a technical and product level.
...
* The TSC shall have a goal of having no more than ⅓ of the TSC from one employer.  Given the requirement that membership in the TSC requires recognized technical and/or product experience with ABC this may not be feasible at the time the TSC is formed, but the TSC should actively work towards this goal.
...
* A Working Group is a segment of the community with knowledge/interest in specific areas of ABC (e.g. UI, Runtime, Infrastructure, documentation) recognized by the TSC.
* The TSC defines each Working Group's mandate, which may include responsibility for certain ABC features, systems and/or code.  A Working Group generally operates independently on the area(s) in which it has a mandate while adhering to ABC's [project guidelines](https://github.com/ampproject/amphtml/tree/master/contributing), [vision/mission](https://www.ampproject.org/about/mission/) and [technical/product roadmaps](https://github.com/ampproject/amphtml/projects/43).
...
* The ABC Project requires all Owners, Collaborators, and Contributors who open a pull request to either accept the terms of an individual Contributor License Agreement (CLA) or be covered by a corporate CLA in order to protect contributors and users in issues of intellectual property.
